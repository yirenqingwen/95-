    ...
    <div class="orderDetail_main">
      <div class="cateItem" @click="gotoDeatil(shangpin)">
            ...
            <div class="cateItem_des">
                ...
                <p class="huohao">{{shangpin.huohao}}</p>
                <p class="price">
                    <span id="price">￥{{shangpin.price}}起 <strong>/ 省 {{shangpin.marketPrice-shangpin.price}}</strong> </span>
                    <span id="stock">{{shangpin.stock}}在售</span>
                </p>
            </div>
        </div>
    </div>
