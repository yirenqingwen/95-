          ...
          <van-tab title="待发货">
            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              <div @click="gotoOrderDetail(item)" slot="header" class="clearfix">
                ...
                <el-button style="float: right; padding: 3px 0;color:black;" type="text"><van-icon name="ellipsis"/></el-button>
              </div>
              <div @click="gotoOrderDetail(item)" class="text item">
                <div class="cateItem">
                    <van-checkbox @click.stop="xuanze" v-model="checked" checked-color="#07c160"></van-checkbox>
