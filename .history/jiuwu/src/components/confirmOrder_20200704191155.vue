  ...
  <div class="confirmOrder">
    ...
    <div class="order_main">
      ...
      <div class="pay">
        ...
        <p>确认提交订单即同意 <a href="">《95分买家协议》</a>及 <a href="">《洗护服务协议》</a> </p>
      </div>
    </div>
    <div class="orderBot">
        <span>实付款：<strong style="color:red;">￥{{checked==false?orderData.price:orderData.price+29.9}}</strong></span>
        <van-button @click="" type="primary">立即购买</van-button>
    </div>
  </div>
</template>
