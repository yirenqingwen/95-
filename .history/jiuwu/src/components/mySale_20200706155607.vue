          ...
          <van-tab title="待上架">
            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              ...
              <div @click="gotoSaleDetail(item)" class="text item">
                ...
                <div class="awPay">
                  <van-button @click.stop="updateSaleStatus(item._id,'待发货')" type="primary" size="mini">上架</van-button>
                </div>
              </div>
            </el-card>
          </van-tab>
          <van-tab title="出售中">
            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              ...
              <div @click="gotoSaleDetail(item)" class="text item">
                ...
                <div class="awPay">
                  <van-button @click.stop="updateSaleStatus(item._id,'待发货')" type="primary" size="mini">交易完成</van-button>
                </div>
              </div>
            </el-card>
          </van-tab>
