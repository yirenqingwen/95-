            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              <div @click="gotoSaleDetail(item)" slot="header" class="clearfix">
                ...
                <el-button style="float: right; padding: 3px 0;color:black;" type="text">
                  <el-popover placement="bototm" width="160" v-model="visible">
                    <div style="text-align: right; margin: 0">
                      <el-button type="primary" size="mini" @click="visible = false">删除寄售单</el-button>
                    </div>
                    <el-button slot="reference"><van-icon @click.stop="showDelate" name="ellipsis" /></el-button>
                  </el-popover>
                </el-button>
              </div>
              <div @click="gotoSaleDetail(item)" class="text item">
                ...
                <div class="awPay">
                  <van-button @click.stop="update()" type="primary" size="mini">立即发货</van-button>
                </div>
              </div>
            </el-card>
          </van-tab>
