          ...
          <van-tab title="出售中">
            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              ...
              <div class="text item">
                ...
                <div class="awPay">
                  <van-button @click.stop="updateSaleStatus2(item._id,'出售中')" type="primary" size="mini">售出</van-button>
                </div>
              </div>
            </el-card>
          </van-tab>
          <van-tab title="待发货">
            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              ...
              <div class="text item">
                ...
                <div class="awPay">
                  <van-button @click.stop="updateSaleStatus2(item._id,'待发货')" type="primary" size="mini">上架</van-button>
                </div>
              </div>
            </el-card>
          </van-tab>
          <van-tab title="已发货">
            ...
            <el-card v-for="(item,index) in saleData" :key="index" class="box-card">
              ...
              <div class="text item">
                ...
                <div class="awPay">
                  <van-button @click.stop="updateSaleStatus2(item._id,'已发货')" type="primary" size="mini">交易完成</van-button>
                </div>
              </div>
            </el-card>
          </van-tab>
...
export default {
  ...
  methods: {
    ...
    updateSaleStatus2(data1,data2) {
        this.api.updateSaleData2({id:data1,nowStatus:data2}).then(
            res=>{
                if(res.data.msg=="操作成功"){
                    this.active2++
                }
