    ...
    <div class="myBuy_main">
      <van-tabs v-model="active">
        ...
        <van-tab title="待支付">
          ...
          <el-card @click="gotoOrderDetail(item)" v-for="(item,index) in mywaitPay" :key="index" class="box-card">
        ...
        <van-tab title="历史交易">
          ...
          <el-card @click="gotoOrderDetail(item)" v-for="(item,index) in mywaitPay" :key="index" class="box-card">
            ...
            <div class="text item">
              ...
              <div class="awPay">
                <van-button @click="delateOrder(item._id)"  type="primary" size="mini">确认收货</van-button>
              </div>
            </div>
          </el-card>
        </van-tab>
