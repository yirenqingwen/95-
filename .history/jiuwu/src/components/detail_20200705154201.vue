<template>
  <div class="detail">
    ...
    <div class="buy">
      <div @click="like" class="shoucang">
        <van-icon ref="star" class="graystar" name="star" />
        <br />收藏
      </div>
      <div class="goumai">
        <div class="p">
...
export default {
  ...
  methods: {
    ...
    like(){
      if(this.$refs.star.className=="graystar green"){
        this.$refs.star.className="graystar"
      }else{
        this.$refs.star.className="graystar green"
      }
    }
  }
};
