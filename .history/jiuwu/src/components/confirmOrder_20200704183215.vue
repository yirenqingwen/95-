<template>
  <div class="confirmOrder">
    ...
    <div class="order_main">
      ...
      <div class="zhangdan">
          <div class="zhangdan_item">商品总额<span>￥{{orderData.price}}</span></div>
          <div class="zhangdan_item">运费<span>￥0.00</span></div>
          <div v-if="checked" class="zhangdan_item">深度洗护服务<span>￥29.90</span></div>
          <div class="zhangdan_item">App首单免邮<span style="color:red;">-￥0.00</span></div>
      </div>
      <div class="pay">
          <van-cell title="支付宝" icon="location-o" /><van-checkbox checked-color="#07c160" v-model="checked"></van-checkbox>
      </div>
    </div>
  </div>
</template>
